---
name: hardcode-audit
description: Scansiona src/ e include/ per hardcode vietati dalle 10 categorie di AGENTS.md. Produce report con file:riga, categoria e suggerimento fix. Codex-only.
user-invocable: false
---

Audit the CAS Engine codebase for forbidden hardcodes as defined in AGENTS.md categories 1-10.
