...
execute_process(
  COMMAND "/usr/bin/git" --git-dir=.git show-ref "b2d9ed2dddefc4b84318d664b4f221eb792d89c7"
  WORKING_DIRECTORY "/Users/REAL_CAS_ENGINE_C++/_deps/rapidcheck-src"
...
if(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/remotes/")
  ...
  set(checkout_name "b2d9ed2dddefc4b84318d664b4f221eb792d89c7")
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("b2d9ed2dddefc4b84318d664b4f221eb792d89c7" tag_sha error_msg)
  if(tag_sha STREQUAL head_sha)
    message(VERBOSE "Already at requested tag: b2d9ed2dddefc4b84318d664b4f221eb792d89c7")
    return()
  endif()
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(checkout_name "origin/b2d9ed2dddefc4b84318d664b4f221eb792d89c7")
  ...
  elseif(tag_sha STREQUAL "")
    ...
    if(NOT can_fetch)
      message(FATAL_ERROR
        "Requested git ref \"b2d9ed2dddefc4b84318d664b4f221eb792d89c7\" is not present locally, and not "
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/Users/REAL_CAS_ENGINE_C++/_deps/rapidcheck-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/Users/REAL_CAS_ENGINE_C++/_deps/rapidcheck-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
