...
Result<std::optional<TowerGenerators>> detect_two_level_tower(
    ExprPtr expr,
    symbolic::CASContext& ctx) {
...
Result<std::optional<AlgebraicTowerTwoLevel>> try_express_in_tower_two_level(
    ExprPtr expr,
    const TowerGenerators& gens,
    symbolic::CASContext& ctx) {
