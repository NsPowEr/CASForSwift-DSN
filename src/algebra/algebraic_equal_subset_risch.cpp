// L2-19 subset-Risch equality normalisation — extracted from algebraic_equal.cpp
// (anti-monolith split 2026-06-28). Holds the positivity-inference oracle
// (infer_positive / _nonnegative / _zero), the log/exp expansion walkers, and
// mathematically_equal_subset_risch. No behavioural change; the main equality
// dispatcher stays in algebraic_equal.cpp.
