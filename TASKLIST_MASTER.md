...
### A6 · Stauduhar Galois group deg ≥ 6 — 🔨 IN CORSO 2026-07-09 (inc.1-4 fatti: perm-engine + lattice + driver deg-6 esatto) — `[E4·C4·S3·R1]`
...
- **🔧 PROSSIMI INCREMENTI**: (5) deg 7 (lattice già generabile, ~minuti: misurare/SLOW_OK; il driver deg-6 è generalizzabile a n qualsiasi cambiando solo `sextic_lattice`→`n`). (6) deg 8..10 = discesa Stauduhar sui massimali + radici certificate interval-Newton (Aberth esiste ma non certificato). Naming strutturale classi non-famose oltre le 8 etichettate.
