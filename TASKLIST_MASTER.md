...
- **Quarantena**: i 2 test rimossi; `PrimitiveElementTest.SqrtTwoSqrtThreeSqrtFive` (facet correlato) rimosso anch'esso, 1.25s dopo A9. CEILING 4 → **1** (resta solo `F2GateBenchmark`). **Ledger**: HC-F8-FACTORIZATIONTOWER-PERF ✅ chiuso.
