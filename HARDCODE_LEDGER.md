...
- **STATO**: 🔨 PARZIALE (f=0 ✅ + f≠0 razionale ✅ wired+sound+doppia-verifica; aperti: WeakNormalizer/residui-interi-negativi, residui algebrici, df>0=A1). **Refs**: A26, A1, HC-F8-PENDING-17.
