...
- **STATO**: ✅ CHIUSO per la parte concludibile senza A1 (f=0 ✅ + f≠0 razionale ✅ + WeakNormalizer positivo ✅ — tutti wired+sound+testati). Residuo non-A26: mult≥2 / residuo>cap / algebrici (Unimplemented pulito), inflate del solver non-parametrico (R3), wiring integrate() (gated A1 df>0). **Refs**: A26, A1, HC-F8-PENDING-17.
